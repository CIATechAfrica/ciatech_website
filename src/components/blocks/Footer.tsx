      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <form className="relative flex flex-col sm:flex-row gap-3 sm:gap-0 mt-2">
              <input 
                 type="email" 
              ...
              <button 
                type="button" 
                className="sm:absolute sm:right-1.5 sm:top-1.5 sm:bottom-1.5 bg-secondary text-primary font-bold px-6 py-2.5 rounded-full text-sm hover:bg-white transition-colors shadow-[0_0_15px_-3px_rgba(226,173,0,0.3)]"
              >
                Subscribe
              </button>
            </form>
