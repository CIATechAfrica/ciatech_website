        ...
        <div className="flex justify-between items-center h-14">
          ...
          <div className="flex items-center justify-end flex-grow sm:flex-grow-0 ml-4 gap-4">
            ...
            <Link
              ...
              className="px-3 py-1.5 rounded-full bg-gray-50 text-gray-700 font-bold text-xs hover:bg-gray-100 transition-colors border border-gray-200 uppercase tracking-widest flex items-center gap-2"
            >
